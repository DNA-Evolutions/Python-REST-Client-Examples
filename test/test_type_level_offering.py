...
class TestTypeLevelOffering(unittest.TestCase):
    """TypeLevelOffering unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypeLevelOffering:
        """Test TypeLevelOffering
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypeLevelOffering`
        """
        model = TypeLevelOffering()
        if include_optional:
            return TypeLevelOffering(
                level = 56
            )
        else:
            return TypeLevelOffering(
    ...
    def testTypeLevelOffering(self):
        """Test TypeLevelOffering"""
