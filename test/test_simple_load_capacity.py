...
class TestSimpleLoadCapacity(unittest.TestCase):
    """SimpleLoadCapacity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleLoadCapacity:
        """Test SimpleLoadCapacity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleLoadCapacity`
        """
        model = SimpleLoadCapacity()
        if include_optional:
            return SimpleLoadCapacity(
                load_capacity_id = '',
                max_capacity_value = 100,
                type_name = 'SimpleLoadCapacity'
            )
        else:
            return SimpleLoadCapacity(
                type_name = 'SimpleLoadCapacity',
    ...
    def testSimpleLoadCapacity(self):
        """Test SimpleLoadCapacity"""
