...
class TestJOptOptimizationError(unittest.TestCase):
    """JOptOptimizationError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JOptOptimizationError:
        """Test JOptOptimizationError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JOptOptimizationError`
        """
        model = JOptOptimizationError()
        if include_optional:
            return JOptOptimizationError(
    ...
    def testJOptOptimizationError(self):
        """Test JOptOptimizationError"""
