...
class TestLongLongPair(unittest.TestCase):
    """LongLongPair unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LongLongPair:
        """Test LongLongPair
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LongLongPair`
        """
        model = LongLongPair()
        if include_optional:
            return LongLongPair(
