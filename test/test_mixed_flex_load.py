...
class TestMixedFlexLoad(unittest.TestCase):
    """MixedFlexLoad unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MixedFlexLoad:
        """Test MixedFlexLoad
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MixedFlexLoad`
        """
        model = MixedFlexLoad()
        if include_optional:
            return MixedFlexLoad(
                load_id = '',
                is_request = True,
                is_fuzzy_visit = True,
                type_name = 'MixedFlexLoad'
            )
        else:
            return MixedFlexLoad(
                type_name = 'MixedFlexLoad',
