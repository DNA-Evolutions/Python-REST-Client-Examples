    ...
    def make_instance(self, include_optional) -> RestOptimization:
        ...
        if include_optional:
            return RestOptimization(
                ...
                zone_connections = [
                    touroptimizer_py_client.models.zone_connection.ZoneConnection(
                        from_zone_id = '1', 
                        to_zone_id = '2', 
                        crossing_penalty_multiplier = 1.337, )
                    ],
                type_dictionaries = touroptimizer_py_client.models.type_dictionaries.TypeDictionaries(
                    type_dictionaries = [
                        touroptimizer_py_client.models.type_dictionary.TypeDictionary(
                            mapping = {
                                'key' : ''
                                }, 
                            type_names = [
                ...
                optimization_options = touroptimizer_py_client.models.optimization_options.OptimizationOptions(
                    ...
                    optimization_scheme_options = touroptimizer_py_client.models.optimization_scheme_options.OptimizationSchemeOptions(
                ...
                extension = touroptimizer_py_client.models.json_config.JSONConfig(
                    ...
                    persistence_setting = touroptimizer_py_client.models.optimization_persistence_setting.OptimizationPersistenceSetting(
                        mongo_settings = touroptimizer_py_client.models.mongo_optimization_persistence_setting.MongoOptimizationPersistenceSetting(
                            ...
                            require_unique_ident_creator_combination = True, 
                            secret = '', 
                            expiry = 'PT48H', 
                            optimization_persistence_strategy_setting = touroptimizer_py_client.models.optimization_persistence_strategy_setting.OptimizationPersistenceStrategySetting(
                                save_connections = False, ), 
                            stream_persistence_strategy_setting = touroptimizer_py_client.models.stream_persistence_strategy_setting.StreamPersistenceStrategySetting(
                                save_progress = True, 
                                cycle_progress = True, 
                                save_status = True, 
                                cycle_status = True, 
