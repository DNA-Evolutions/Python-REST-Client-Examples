...
class TestResourceTrip(unittest.TestCase):
    """ResourceTrip unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResourceTrip:
        """Test ResourceTrip
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResourceTrip`
        """
        model = ResourceTrip()
        if include_optional:
            return ResourceTrip(
