...
class TestGeoAddress(unittest.TestCase):
    """GeoAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeoAddress:
        """Test GeoAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoAddress`
        """
        model = GeoAddress()
        if include_optional:
            return GeoAddress(
