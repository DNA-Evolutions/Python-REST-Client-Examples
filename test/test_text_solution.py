...
class TestTextSolution(unittest.TestCase):
    """TextSolution unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TextSolution:
        """Test TextSolution
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TextSolution`
        """
        model = TextSolution()
        if include_optional:
            return TextSolution(
