...
class TestPluginSetting(unittest.TestCase):
    """PluginSetting unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PluginSetting:
        """Test PluginSetting
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PluginSetting`
        """
        model = PluginSetting()
        if include_optional:
