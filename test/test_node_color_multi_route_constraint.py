...
class TestNodeColorMultiRouteConstraint(unittest.TestCase):
    """NodeColorMultiRouteConstraint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodeColorMultiRouteConstraint:
        """Test NodeColorMultiRouteConstraint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeColorMultiRouteConstraint`
        """
        model = NodeColorMultiRouteConstraint()
        if include_optional:
            return NodeColorMultiRouteConstraint(
                ...
                type_name = 'NodeColorMultiRouteConstraint'
            )
        else:
            return NodeColorMultiRouteConstraint(
                mirror_item = touroptimizer_py_client.models.integer_multi_constraint_helper_item.IntegerMultiConstraintHelperItem(
    ...
    def testNodeColorMultiRouteConstraint(self):
        """Test NodeColorMultiRouteConstraint"""
