...
class TestZoneNumberQualification(unittest.TestCase):
    """ZoneNumberQualification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ZoneNumberQualification:
        """Test ZoneNumberQualification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ZoneNumberQualification`
        """
        model = ZoneNumberQualification()
        if include_optional:
            return ZoneNumberQualification(
                my_code = touroptimizer_py_client.models.zone_code_type.ZoneCodeType(
                    type_name = '', ),
                my_extra_codes = [
                    touroptimizer_py_client.models.zone_code_type.ZoneCodeType(
                        type_name = '', )
                    ],
                type_name = 'ZoneNumberQualification'
            )
        else:
            return ZoneNumberQualification(
                type_name = 'ZoneNumberQualification',
    ...
    def testZoneNumberQualification(self):
        """Test ZoneNumberQualification"""
