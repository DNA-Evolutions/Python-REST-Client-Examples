...
class TestQualificationType(unittest.TestCase):
    """QualificationType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QualificationType:
        """Test QualificationType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QualificationType`
        """
    ...
    def testQualificationType(self):
        """Test QualificationType"""
