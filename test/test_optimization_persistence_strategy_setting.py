...
class TestOptimizationPersistenceStrategySetting(unittest.TestCase):
    """OptimizationPersistenceStrategySetting unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OptimizationPersistenceStrategySetting:
        """Test OptimizationPersistenceStrategySetting
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OptimizationPersistenceStrategySetting`
        """
        model = OptimizationPersistenceStrategySetting()
        if include_optional:
            return OptimizationPersistenceStrategySetting(
    ...
    def testOptimizationPersistenceStrategySetting(self):
        """Test OptimizationPersistenceStrategySetting"""
