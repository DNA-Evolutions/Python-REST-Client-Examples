...
class TestEventPillarNode(unittest.TestCase):
    """EventPillarNode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventPillarNode:
        """Test EventPillarNode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventPillarNode`
        """
        model = EventPillarNode()
        if include_optional:
            return EventPillarNode(
                attached_resource_id = '',
                only_scheduled_in_company = True,
                type_name = 'EventPillarNode',
