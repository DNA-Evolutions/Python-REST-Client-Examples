...
class TestStartReductionTimeIncludeDefinition(unittest.TestCase):
    """StartReductionTimeIncludeDefinition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StartReductionTimeIncludeDefinition:
        """Test StartReductionTimeIncludeDefinition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StartReductionTimeIncludeDefinition`
        """
        model = StartReductionTimeIncludeDefinition()
        if include_optional:
            return StartReductionTimeIncludeDefinition(
    ...
    def testStartReductionTimeIncludeDefinition(self):
        """Test StartReductionTimeIncludeDefinition"""
