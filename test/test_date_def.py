...
class TestDateDef(unittest.TestCase):
    """DateDef unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DateDef:
        """Test DateDef
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DateDef`
        """
        model = DateDef()
        if include_optional:
            return DateDef(
