...
class TestTypeWithExpertiseQualification(unittest.TestCase):
    """TypeWithExpertiseQualification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypeWithExpertiseQualification:
        """Test TypeWithExpertiseQualification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypeWithExpertiseQualification`
        """
        model = TypeWithExpertiseQualification()
        if include_optional:
            return TypeWithExpertiseQualification(
    ...
    def testTypeWithExpertiseQualification(self):
        """Test TypeWithExpertiseQualification"""
