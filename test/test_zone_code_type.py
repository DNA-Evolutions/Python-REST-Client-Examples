...
class TestZoneCodeType(unittest.TestCase):
    """ZoneCodeType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ZoneCodeType:
        """Test ZoneCodeType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ZoneCodeType`
        """
        model = ZoneCodeType()
        if include_optional:
            return ZoneCodeType(
