...
class TestBitTypeConstraint(unittest.TestCase):
    """BitTypeConstraint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BitTypeConstraint:
        """Test BitTypeConstraint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BitTypeConstraint`
        """
        model = BitTypeConstraint()
        if include_optional:
            return BitTypeConstraint(
                type_names = [
                    ''
                    ],
                type_name = 'BitType'
    ...
    def testBitTypeConstraint(self):
        """Test BitTypeConstraint"""
