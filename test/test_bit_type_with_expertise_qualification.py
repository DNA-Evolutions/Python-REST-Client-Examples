...
class TestBitTypeWithExpertiseQualification(unittest.TestCase):
    """BitTypeWithExpertiseQualification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BitTypeWithExpertiseQualification:
        """Test BitTypeWithExpertiseQualification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BitTypeWithExpertiseQualification`
        """
        model = BitTypeWithExpertiseQualification()
        if include_optional:
            return BitTypeWithExpertiseQualification(
                dict_type_names = [
                    ''
                    ],
                dict_mapping = {
                    'key' : touroptimizer_py_client.models.type_level_offering.TypeLevelOffering(
                        level = 56, )
                    },
    ...
    def testBitTypeWithExpertiseQualification(self):
        """Test BitTypeWithExpertiseQualification"""
