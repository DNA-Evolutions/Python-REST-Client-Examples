...
class TestSameVisitorNodeRelation(unittest.TestCase):
    """SameVisitorNodeRelation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SameVisitorNodeRelation:
        """Test SameVisitorNodeRelation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SameVisitorNodeRelation`
        """
        model = SameVisitorNodeRelation()
        if include_optional:
            return SameVisitorNodeRelation(
                type_name = 'SameVisitor'
            )
        else:
            return SameVisitorNodeRelation(
                type_name = 'SameVisitor',
    ...
    def testSameVisitorNodeRelation(self):
        """Test SameVisitorNodeRelation"""
