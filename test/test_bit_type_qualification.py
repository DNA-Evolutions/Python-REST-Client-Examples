...
class TestBitTypeQualification(unittest.TestCase):
    """BitTypeQualification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BitTypeQualification:
        """Test BitTypeQualification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BitTypeQualification`
        """
        model = BitTypeQualification()
        if include_optional:
            return BitTypeQualification(
                type_names = [
                    ''
                    ],
                type_name = 'BitType'
    ...
    def testBitTypeQualification(self):
        """Test BitTypeQualification"""
