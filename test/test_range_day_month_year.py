...
class TestRangeDayMonthYear(unittest.TestCase):
    """RangeDayMonthYear unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RangeDayMonthYear:
        """Test RangeDayMonthYear
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RangeDayMonthYear`
        """
        model = RangeDayMonthYear()
        if include_optional:
            return RangeDayMonthYear(
                var_from = touroptimizer_py_client.models.day_month_year.DayMonthYear(),
                to = touroptimizer_py_client.models.day_month_year.DayMonthYear()
            )
        else:
            return RangeDayMonthYear(
        )
    ...
    def testRangeDayMonthYear(self):
        """Test RangeDayMonthYear"""
