...
class TestAbsoluteNodeColorCapacity(unittest.TestCase):
    """AbsoluteNodeColorCapacity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AbsoluteNodeColorCapacity:
        """Test AbsoluteNodeColorCapacity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AbsoluteNodeColorCapacity`
        """
        model = AbsoluteNodeColorCapacity()
        if include_optional:
            return AbsoluteNodeColorCapacity(
    ...
    def testAbsoluteNodeColorCapacity(self):
        """Test AbsoluteNodeColorCapacity"""
