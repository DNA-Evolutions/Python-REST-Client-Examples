...
class TestMaxDistanceConstructionHook(unittest.TestCase):
    """MaxDistanceConstructionHook unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaxDistanceConstructionHook:
        """Test MaxDistanceConstructionHook
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaxDistanceConstructionHook`
        """
        model = MaxDistanceConstructionHook()
        if include_optional:
            return MaxDistanceConstructionHook(
                type_name = 'MaxDistanceConstructionHook',
                prioritize_node_connector_on_fallback_speed = True,
                only_apply_once = True,
                invocation_position = 'PRE_CONSTRUCTION',
                driven_time = 'PT120M',
                driven_distance = '100.0 km',
                is_active = True
            )
        else:
            return MaxDistanceConstructionHook(
    ...
    def testMaxDistanceConstructionHook(self):
        """Test MaxDistanceConstructionHook"""
