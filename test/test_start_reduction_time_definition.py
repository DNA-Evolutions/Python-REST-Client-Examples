...
class TestStartReductionTimeDefinition(unittest.TestCase):
    """StartReductionTimeDefinition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StartReductionTimeDefinition:
        """Test StartReductionTimeDefinition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StartReductionTimeDefinition`
        """
        model = StartReductionTimeDefinition()
        if include_optional:
            return StartReductionTimeDefinition(
    ...
    def testStartReductionTimeDefinition(self):
        """Test StartReductionTimeDefinition"""
