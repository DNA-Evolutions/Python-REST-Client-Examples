...
class TestTimeComparisonJuncture(unittest.TestCase):
    """TimeComparisonJuncture unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeComparisonJuncture:
        """Test TimeComparisonJuncture
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeComparisonJuncture`
        """
        model = TimeComparisonJuncture()
        if include_optional:
            return TimeComparisonJuncture(
    ...
    def testTimeComparisonJuncture(self):
        """Test TimeComparisonJuncture"""
