...
class TestHeuristicOptimizationAlgorithmConfig(unittest.TestCase):
    """HeuristicOptimizationAlgorithmConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HeuristicOptimizationAlgorithmConfig:
        """Test HeuristicOptimizationAlgorithmConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HeuristicOptimizationAlgorithmConfig`
        """
        model = HeuristicOptimizationAlgorithmConfig()
        if include_optional:
            return HeuristicOptimizationAlgorithmConfig(
    ...
    def testHeuristicOptimizationAlgorithmConfig(self):
        """Test HeuristicOptimizationAlgorithmConfig"""
