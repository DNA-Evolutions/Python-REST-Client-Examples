...
class TestDifferentVisitorNodeRelation(unittest.TestCase):
    """DifferentVisitorNodeRelation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DifferentVisitorNodeRelation:
        """Test DifferentVisitorNodeRelation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DifferentVisitorNodeRelation`
        """
        model = DifferentVisitorNodeRelation()
        if include_optional:
            return DifferentVisitorNodeRelation(
                type_name = 'DifferentVisitor'
            )
        else:
            return DifferentVisitorNodeRelation(
                type_name = 'DifferentVisitor',
    ...
    def testDifferentVisitorNodeRelation(self):
        """Test DifferentVisitorNodeRelation"""
