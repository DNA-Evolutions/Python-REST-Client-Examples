...
class TestResourceWithPriority(unittest.TestCase):
    """ResourceWithPriority unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResourceWithPriority:
        """Test ResourceWithPriority
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResourceWithPriority`
        """
        model = ResourceWithPriority()
        if include_optional:
            return ResourceWithPriority(
                resource_id = 'Alex',
                priority = 5
            )
        else:
    ...
    def testResourceWithPriority(self):
        """Test ResourceWithPriority"""
