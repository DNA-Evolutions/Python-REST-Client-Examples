...
class TestBindingResourceConstraint(unittest.TestCase):
    """BindingResourceConstraint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BindingResourceConstraint:
        """Test BindingResourceConstraint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BindingResourceConstraint`
        """
        model = BindingResourceConstraint()
        if include_optional:
            return BindingResourceConstraint(
                resources = [
                    touroptimizer_py_client.models.resource_with_priority.ResourceWithPriority(
                        resource_id = 'Alex', 
                        priority = 5, )
                    ],
                type_name = 'BindingResource'
            )
        else:
            return BindingResourceConstraint(
                resources = [
    ...
    def testBindingResourceConstraint(self):
        """Test BindingResourceConstraint"""
