...
class TestOptimizationKeySetting(unittest.TestCase):
    """OptimizationKeySetting unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OptimizationKeySetting:
        """Test OptimizationKeySetting
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OptimizationKeySetting`
        """
        model = OptimizationKeySetting()
        if include_optional:
            return OptimizationKeySetting(
                json_license = ''
            )
        else:
            return OptimizationKeySetting(
    ...
    def testOptimizationKeySetting(self):
        """Test OptimizationKeySetting"""
