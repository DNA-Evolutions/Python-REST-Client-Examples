...
class TestStayOutCycleDefinition(unittest.TestCase):
    """StayOutCycleDefinition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StayOutCycleDefinition:
        """Test StayOutCycleDefinition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StayOutCycleDefinition`
        """
        model = StayOutCycleDefinition()
        if include_optional:
            return StayOutCycleDefinition(
                cycle_length = 'PT7D',
    ...
    def testStayOutCycleDefinition(self):
        """Test StayOutCycleDefinition"""
