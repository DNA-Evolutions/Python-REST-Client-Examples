...
class TestWriteDatabaseServiceControllerApi(unittest.TestCase):
    """WriteDatabaseServiceControllerApi unit test stubs"""

    def setUp(self) -> None:
        self.api = WriteDatabaseServiceControllerApi()

    def tearDown(self) -> None:
        pass

    def test_save_optimization(self) -> None:
        """Test case for save_optimization
