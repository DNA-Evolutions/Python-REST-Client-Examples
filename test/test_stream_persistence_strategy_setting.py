...
class TestStreamPersistenceStrategySetting(unittest.TestCase):
    """StreamPersistenceStrategySetting unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StreamPersistenceStrategySetting:
        """Test StreamPersistenceStrategySetting
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StreamPersistenceStrategySetting`
        """
        model = StreamPersistenceStrategySetting()
        if include_optional:
            return StreamPersistenceStrategySetting(
                save_progress = True,
                cycle_progress = True,
                save_status = True,
                cycle_status = True,
    ...
    def testStreamPersistenceStrategySetting(self):
        """Test StreamPersistenceStrategySetting"""
