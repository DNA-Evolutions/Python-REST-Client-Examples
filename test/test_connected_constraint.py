...
class TestConnectedConstraint(unittest.TestCase):
    """ConnectedConstraint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectedConstraint:
        """Test ConnectedConstraint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectedConstraint`
        """
        model = ConnectedConstraint()
        if include_optional:
            return ConnectedConstraint(
                constraint_one = touroptimizer_py_client.models.constraint.Constraint(
                    initial_class_name = '', 
                    type = touroptimizer_py_client.models.constraint_type.ConstraintType(
                        type_name = '', ), 
                    is_hard = True, ),
                constraint_two = touroptimizer_py_client.models.constraint.Constraint(
                    initial_class_name = '', 
                    type = touroptimizer_py_client.models.constraint_type.ConstraintType(
                        type_name = '', ), 
                    is_hard = True, ),
                connection_type = 'AND_CONNECTION_TYPE',
                type_name = 'ConnectedConstraint'
            )
        else:
            return ConnectedConstraint(
                constraint_one = touroptimizer_py_client.models.constraint.Constraint(
    ...
    def testConnectedConstraint(self):
        """Test ConnectedConstraint"""
