...
class TestConstructionOptimizationAlgorithmConfig(unittest.TestCase):
    """ConstructionOptimizationAlgorithmConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConstructionOptimizationAlgorithmConfig:
        """Test ConstructionOptimizationAlgorithmConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConstructionOptimizationAlgorithmConfig`
        """
        model = ConstructionOptimizationAlgorithmConfig()
        if include_optional:
            return ConstructionOptimizationAlgorithmConfig(
    ...
    def testConstructionOptimizationAlgorithmConfig(self):
        """Test ConstructionOptimizationAlgorithmConfig"""
