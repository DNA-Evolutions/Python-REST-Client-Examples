...
class TestSecurityHelperItemMetadata(unittest.TestCase):
    """SecurityHelperItemMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SecurityHelperItemMetadata:
        """Test SecurityHelperItemMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SecurityHelperItemMetadata`
        """
        model = SecurityHelperItemMetadata()
        if include_optional:
            return SecurityHelperItemMetadata(
                enc_mode = 'CLIENT',
                iv = 'dPrQge5LIDdPxEeg',
    ...
    def testSecurityHelperItemMetadata(self):
        """Test SecurityHelperItemMetadata"""
