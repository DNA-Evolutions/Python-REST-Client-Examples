...
class TestNodeRelationType(unittest.TestCase):
    """NodeRelationType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodeRelationType:
        """Test NodeRelationType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeRelationType`
        """
        model = NodeRelationType()
        if include_optional:
            return NodeRelationType(
                type_name = ''
            )
        else:
            return NodeRelationType(
