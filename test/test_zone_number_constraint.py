...
class TestZoneNumberConstraint(unittest.TestCase):
    """ZoneNumberConstraint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ZoneNumberConstraint:
        """Test ZoneNumberConstraint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ZoneNumberConstraint`
        """
        model = ZoneNumberConstraint()
        if include_optional:
            return ZoneNumberConstraint(
                zone_codes = [
                    touroptimizer_py_client.models.zone_code_type.ZoneCodeType(
                        type_name = '', )
                    ],
                type_name = 'ZoneNumberConstraint'
            )
        else:
            return ZoneNumberConstraint(
                zone_codes = [
    ...
    def testZoneNumberConstraint(self):
        """Test ZoneNumberConstraint"""
