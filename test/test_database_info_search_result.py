    ...
    def make_instance(self, include_optional) -> DatabaseInfoSearchResult:
        ...
        if include_optional:
            return DatabaseInfoSearchResult(
                ...
                ident = 'JOpt-Run-1775130113116',
                created_time_stamp = 1775130148792,
                status = touroptimizer_py_client.models.optimization_status.OptimizationStatus(
                    status_description = '', 
                    error = '', 
                    status = 'UNKNOWN', ),
                sec = touroptimizer_py_client.models.security_helper_item_metadata.SecurityHelperItemMetadata(
                    ...
                    iteration_count = 310000, 
                    wrapped_dek = 'BASE64_WRAPPED_KEY', 
                    kek_id = 'https://myvault.vault.azure.net/keys/tenant-kek/abc123', 
                    kms_mode = False, )
            )
        else:
            return DatabaseInfoSearchResult(
