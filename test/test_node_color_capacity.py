...
class TestNodeColorCapacity(unittest.TestCase):
    """NodeColorCapacity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodeColorCapacity:
        """Test NodeColorCapacity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeColorCapacity`
        """
        model = NodeColorCapacity()
        if include_optional:
            return NodeColorCapacity(
    ...
    def testNodeColorCapacity(self):
        """Test NodeColorCapacity"""
