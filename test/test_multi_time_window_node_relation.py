...
class TestMultiTimeWindowNodeRelation(unittest.TestCase):
    """MultiTimeWindowNodeRelation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultiTimeWindowNodeRelation:
        """Test MultiTimeWindowNodeRelation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultiTimeWindowNodeRelation`
        """
        model = MultiTimeWindowNodeRelation()
        if include_optional:
            return MultiTimeWindowNodeRelation(
                type_name = 'MultiTimeWindow',
                anchor_details = [
                ...
                is_need_same_visitor = True,
                is_overlap_allowed = True
            )
        else:
            return MultiTimeWindowNodeRelation(
                type_name = 'MultiTimeWindow',
    ...
    def testMultiTimeWindowNodeRelation(self):
        """Test MultiTimeWindowNodeRelation"""
