...
class TestReadDatabaseDownloadServiceControllerApi(unittest.TestCase):
    """ReadDatabaseDownloadServiceControllerApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ReadDatabaseDownloadServiceControllerApi()

    def tearDown(self) -> None:
        pass

    def test_download_zipped_optimization(self) -> None:
        """Test case for download_zipped_optimization

        Download optimization by id and creator. Only works, if connected to a database.
        """
        pass

    def test_download_zipped_solution(self) -> None:
        """Test case for download_zipped_solution
