...
class TestStayOutDefinition(unittest.TestCase):
    """StayOutDefinition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StayOutDefinition:
        """Test StayOutDefinition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StayOutDefinition`
        """
        model = StayOutDefinition()
        if include_optional:
            return StayOutDefinition(
    ...
    def testStayOutDefinition(self):
        """Test StayOutDefinition"""
