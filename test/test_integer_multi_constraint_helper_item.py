...
class TestIntegerMultiConstraintHelperItem(unittest.TestCase):
    """IntegerMultiConstraintHelperItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntegerMultiConstraintHelperItem:
        """Test IntegerMultiConstraintHelperItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntegerMultiConstraintHelperItem`
        """
        model = IntegerMultiConstraintHelperItem()
        if include_optional:
            return IntegerMultiConstraintHelperItem(
                pairs = [
    ...
    def testIntegerMultiConstraintHelperItem(self):
        """Test IntegerMultiConstraintHelperItem"""
