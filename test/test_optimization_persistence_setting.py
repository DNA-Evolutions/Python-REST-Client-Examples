...
class TestOptimizationPersistenceSetting(unittest.TestCase):
    """OptimizationPersistenceSetting unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OptimizationPersistenceSetting:
        """Test OptimizationPersistenceSetting
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OptimizationPersistenceSetting`
        """
        model = OptimizationPersistenceSetting()
        if include_optional:
            return OptimizationPersistenceSetting(
    ...
    def testOptimizationPersistenceSetting(self):
        """Test OptimizationPersistenceSetting"""
