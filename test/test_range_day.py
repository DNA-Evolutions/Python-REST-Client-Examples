...
class TestRangeDay(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RangeDay:
        """Test RangeDay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RangeDay`
        """
        model = RangeDay()
        if include_optional:
            return RangeDay(
                var_from = touroptimizer_py_client.models.day.Day(),
                to = touroptimizer_py_client.models.day.Day()
            )
        else:
            return RangeDay(
        )
