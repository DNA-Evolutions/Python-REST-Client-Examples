...
class TestOfferedNode(unittest.TestCase):
    """OfferedNode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OfferedNode:
        """Test OfferedNode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OfferedNode`
        """
        model = OfferedNode()
        if include_optional:
            return OfferedNode(
