...
class TestConstructionHook(unittest.TestCase):
    """ConstructionHook unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConstructionHook:
        """Test ConstructionHook
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConstructionHook`
        """
        model = ConstructionHook()
        if include_optional:
            return ConstructionHook(
