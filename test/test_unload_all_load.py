...
class TestUnloadAllLoad(unittest.TestCase):
    """UnloadAllLoad unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnloadAllLoad:
        """Test UnloadAllLoad
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnloadAllLoad`
        """
        model = UnloadAllLoad()
        if include_optional:
            return UnloadAllLoad(
                load_id = '',
                is_request = True,
                is_fuzzy_visit = True,
                type_name = 'UnloadAllLoad'
            )
        else:
            return UnloadAllLoad(
                type_name = 'UnloadAllLoad',
