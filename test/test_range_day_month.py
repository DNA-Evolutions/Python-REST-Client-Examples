...
class TestRangeDayMonth(unittest.TestCase):
    """RangeDayMonth unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RangeDayMonth:
        """Test RangeDayMonth
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RangeDayMonth`
        """
        model = RangeDayMonth()
        if include_optional:
            return RangeDayMonth(
                var_from = touroptimizer_py_client.models.day_month.DayMonth(),
                to = touroptimizer_py_client.models.day_month.DayMonth()
            )
        else:
            return RangeDayMonth(
        )
