...
class TestElementConnectionType(unittest.TestCase):
    """ElementConnectionType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ElementConnectionType:
        """Test ElementConnectionType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ElementConnectionType`
        """
        model = ElementConnectionType()
        if include_optional:
    ...
    def testElementConnectionType(self):
        """Test ElementConnectionType"""
