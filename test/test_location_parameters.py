...
class TestLocationParameters(unittest.TestCase):
    """LocationParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocationParameters:
        """Test LocationParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocationParameters`
        """
        model = LocationParameters()
        if include_optional:
    ...
    def testLocationParameters(self):
        """Test LocationParameters"""
