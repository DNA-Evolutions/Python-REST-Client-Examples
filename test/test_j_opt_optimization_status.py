...
class TestJOptOptimizationStatus(unittest.TestCase):
    """JOptOptimizationStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JOptOptimizationStatus:
        """Test JOptOptimizationStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JOptOptimizationStatus`
        """
        model = JOptOptimizationStatus()
        if include_optional:
            return JOptOptimizationStatus(
    ...
    def testJOptOptimizationStatus(self):
        """Test JOptOptimizationStatus"""
