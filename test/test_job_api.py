...
class TestJobApi(unittest.TestCase):
    ...
    def test_get_job_progress(self) -> None:
        """Test case for get_job_progress
    ...
    def test_get_job_solution(self) -> None:
        """Test case for get_job_solution
    ...
    def test_get_job_warnings(self) -> None:
        """Test case for get_job_warnings
