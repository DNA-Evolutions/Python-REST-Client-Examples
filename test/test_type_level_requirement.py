...
class TestTypeLevelRequirement(unittest.TestCase):
    """TypeLevelRequirement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypeLevelRequirement:
        """Test TypeLevelRequirement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypeLevelRequirement`
        """
        model = TypeLevelRequirement()
        if include_optional:
    ...
    def testTypeLevelRequirement(self):
        """Test TypeLevelRequirement"""
