...
class TestTypeWithExpertise(unittest.TestCase):
    """TypeWithExpertise unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypeWithExpertise:
        """Test TypeWithExpertise
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypeWithExpertise`
        """
        model = TypeWithExpertise()
        if include_optional:
            return TypeWithExpertise(
                type = '',
                level = 1.337,
                is_min = True
            )
    ...
    def testTypeWithExpertise(self):
        """Test TypeWithExpertise"""
