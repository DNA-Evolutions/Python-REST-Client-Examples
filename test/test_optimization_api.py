...
class TestOptimizationApi(unittest.TestCase):
    ...
    def test_get_run_result(self) -> None:
        """Test case for get_run_result

        Retrieve the full result of a run (blocks until complete).
        """
        pass

    def test_get_run_solution(self) -> None:
        """Test case for get_run_solution

        Retrieve the solution of a run (blocks until complete).
        """
        pass

    def test_get_started_signal(self) -> None:
        """Test case for get_started_signal
    ...
    def test_stream_progress(self) -> None:
        """Test case for stream_progress

        SSE stream of optimization progress for a run.
        """
        pass

    def test_stream_status(self) -> None:
        """Test case for stream_status

        SSE stream of optimization status messages for a run.
        """
        pass

    def test_stream_warnings(self) -> None:
        """Test case for stream_warnings
