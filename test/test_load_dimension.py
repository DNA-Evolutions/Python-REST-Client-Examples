...
class TestLoadDimension(unittest.TestCase):
    """LoadDimension unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LoadDimension:
        """Test LoadDimension
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoadDimension`
        """
        model = LoadDimension()
        if include_optional:
