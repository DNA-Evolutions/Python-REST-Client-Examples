...
class TestResourceLocationConstraint(unittest.TestCase):
    """ResourceLocationConstraint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResourceLocationConstraint:
        """Test ResourceLocationConstraint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResourceLocationConstraint`
        """
        model = ResourceLocationConstraint()
        if include_optional:
            return ResourceLocationConstraint(
                max_radius_distance = '100.0 km',
                max_radius_time = 'PT2H',
                type_name = 'ResourceLocationConstraint'
            )
        else:
            return ResourceLocationConstraint(
                type_name = 'ResourceLocationConstraint',
    ...
    def testResourceLocationConstraint(self):
        """Test ResourceLocationConstraint"""
