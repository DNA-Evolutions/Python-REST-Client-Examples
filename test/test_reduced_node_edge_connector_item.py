...
class TestReducedNodeEdgeConnectorItem(unittest.TestCase):
    """ReducedNodeEdgeConnectorItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReducedNodeEdgeConnectorItem:
        """Test ReducedNodeEdgeConnectorItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReducedNodeEdgeConnectorItem`
        """
        model = ReducedNodeEdgeConnectorItem()
        if include_optional:
            return ReducedNodeEdgeConnectorItem(
                distance = '100.0 km',
                time = 'PT30M',
    ...
    def testReducedNodeEdgeConnectorItem(self):
        """Test ReducedNodeEdgeConnectorItem"""
