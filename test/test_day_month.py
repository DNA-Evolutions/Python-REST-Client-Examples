...
class TestDayMonth(unittest.TestCase):
    """DayMonth unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DayMonth:
        """Test DayMonth
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DayMonth`
        """
        model = DayMonth()
        if include_optional:
            return DayMonth(
