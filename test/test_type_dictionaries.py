...
class TestTypeDictionaries(unittest.TestCase):
    """TypeDictionaries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypeDictionaries:
        """Test TypeDictionaries
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypeDictionaries`
        """
        model = TypeDictionaries()
        if include_optional:
