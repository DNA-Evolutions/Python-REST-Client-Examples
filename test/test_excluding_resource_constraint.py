...
class TestExcludingResourceConstraint(unittest.TestCase):
    """ExcludingResourceConstraint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExcludingResourceConstraint:
        """Test ExcludingResourceConstraint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExcludingResourceConstraint`
        """
        model = ExcludingResourceConstraint()
        if include_optional:
            return ExcludingResourceConstraint(
                resources = [
                    touroptimizer_py_client.models.resource_with_priority.ResourceWithPriority(
                        resource_id = 'Alex', 
                        priority = 5, )
                    ],
                type_name = 'ExcludingResource'
            )
        else:
            return ExcludingResourceConstraint(
                resources = [
    ...
    def testExcludingResourceConstraint(self):
        """Test ExcludingResourceConstraint"""
