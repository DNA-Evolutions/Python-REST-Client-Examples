...
class TestJobAcceptedResponse(unittest.TestCase):
    """JobAcceptedResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobAcceptedResponse:
        """Test JobAcceptedResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobAcceptedResponse`
        """
        model = JobAcceptedResponse()
        if include_optional:
            return JobAcceptedResponse(
                job_id = '6274e36cc36712358912bf35',
                creator_hash = '025b6ba9c209f999e4900b78952263f6143bfee777567f104cf19413be902936',
                ident = 'My-JOpt-Run',
                submitted_at = 517464000,
                status = 'ACCEPTED'
            )
        else:
            return JobAcceptedResponse(
    ...
    def testJobAcceptedResponse(self):
        """Test JobAcceptedResponse"""
