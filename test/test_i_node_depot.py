...
class TestINodeDepot(unittest.TestCase):
    """INodeDepot unit test stubs"""
    ...
    def make_instance(self, include_optional) -> INodeDepot:
        """Test INodeDepot
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `INodeDepot`
        """
        model = INodeDepot()
        if include_optional:
            return INodeDepot(
