...
class TestCoreBuildOptions(unittest.TestCase):
    """CoreBuildOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoreBuildOptions:
        """Test CoreBuildOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoreBuildOptions`
        """
        model = CoreBuildOptions()
        if include_optional:
