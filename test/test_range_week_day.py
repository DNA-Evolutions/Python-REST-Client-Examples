...
class TestRangeWeekDay(unittest.TestCase):
    """RangeWeekDay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RangeWeekDay:
        """Test RangeWeekDay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RangeWeekDay`
        """
        model = RangeWeekDay()
        if include_optional:
            return RangeWeekDay(
