...
class TestRequestFlexLoad(unittest.TestCase):
    """RequestFlexLoad unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestFlexLoad:
        """Test RequestFlexLoad
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestFlexLoad`
        """
        model = RequestFlexLoad()
        if include_optional:
            return RequestFlexLoad(
                load_id = '',
                is_request = True,
                is_fuzzy_visit = True,
                type_name = 'RequestFlexLoad'
            )
        else:
            return RequestFlexLoad(
                type_name = 'RequestFlexLoad',
