...
class TestSupplyFlexLoad(unittest.TestCase):
    """SupplyFlexLoad unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupplyFlexLoad:
        """Test SupplyFlexLoad
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupplyFlexLoad`
        """
        model = SupplyFlexLoad()
        if include_optional:
            return SupplyFlexLoad(
                load_id = '',
                is_request = True,
                is_fuzzy_visit = True,
                type_name = 'SupplyFlexLoad'
            )
        else:
            return SupplyFlexLoad(
                type_name = 'SupplyFlexLoad',
