...
class TestEncodedPolyline(unittest.TestCase):
    """EncodedPolyline unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EncodedPolyline:
        """Test EncodedPolyline
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EncodedPolyline`
        """
        model = EncodedPolyline()
        if include_optional:
