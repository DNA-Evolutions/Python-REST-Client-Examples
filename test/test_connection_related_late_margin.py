...
class TestConnectionRelatedLateMargin(unittest.TestCase):
    """ConnectionRelatedLateMargin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectionRelatedLateMargin:
        """Test ConnectionRelatedLateMargin
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectionRelatedLateMargin`
        """
        model = ConnectionRelatedLateMargin()
        if include_optional:
            return ConnectionRelatedLateMargin(
    ...
    def testConnectionRelatedLateMargin(self):
        """Test ConnectionRelatedLateMargin"""
