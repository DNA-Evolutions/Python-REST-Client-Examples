...
class TestBitTypeWithExpertiseConstraint(unittest.TestCase):
    """BitTypeWithExpertiseConstraint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BitTypeWithExpertiseConstraint:
        """Test BitTypeWithExpertiseConstraint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BitTypeWithExpertiseConstraint`
        """
        model = BitTypeWithExpertiseConstraint()
        if include_optional:
            return BitTypeWithExpertiseConstraint(
                dict_type_names = [
                    ''
                    ],
                dict_mapping = {
                    'key' : touroptimizer_py_client.models.type_level_requirement.TypeLevelRequirement(
                        level = 56, 
                        is_min = True, )
                    },
                info_cost_model = 'PENALIZE_MATCHING_SKILL_HIGH_DELTA',
                type_name = 'BitTypeWithExpertise',
                is_hard_level = True
            )
        else:
            return BitTypeWithExpertiseConstraint(
    ...
    def testBitTypeWithExpertiseConstraint(self):
        """Test BitTypeWithExpertiseConstraint"""
