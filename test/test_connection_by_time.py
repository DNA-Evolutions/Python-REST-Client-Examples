...
class TestConnectionByTime(unittest.TestCase):
    """ConnectionByTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectionByTime:
        """Test ConnectionByTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectionByTime`
        """
        model = ConnectionByTime()
        if include_optional:
            return ConnectionByTime(
                time_definitions = [
                    null
                    ],
                time_millis = [
