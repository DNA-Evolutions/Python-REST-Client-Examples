...
class TestAbsoluteNodeColorMultiRouteConstraint(unittest.TestCase):
    """AbsoluteNodeColorMultiRouteConstraint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AbsoluteNodeColorMultiRouteConstraint:
        """Test AbsoluteNodeColorMultiRouteConstraint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AbsoluteNodeColorMultiRouteConstraint`
        """
        model = AbsoluteNodeColorMultiRouteConstraint()
        if include_optional:
            return AbsoluteNodeColorMultiRouteConstraint(
                mirror_item = touroptimizer_py_client.models.integer_multi_constraint_helper_item.IntegerMultiConstraintHelperItem(
                    pairs = [
                        touroptimizer_py_client.models.string_integer_pair.StringIntegerPair(
                            left = '', 
                            right = 56, )
                        ], ),
                absolute_node_color_capacities = [
                    touroptimizer_py_client.models.absolute_node_color_capacity.AbsoluteNodeColorCapacity(
                ...
                type_name = 'AbsoluteNodeColorMultiRouteConstraint'
            )
        else:
            return AbsoluteNodeColorMultiRouteConstraint(
                mirror_item = touroptimizer_py_client.models.integer_multi_constraint_helper_item.IntegerMultiConstraintHelperItem(
    ...
    def testAbsoluteNodeColorMultiRouteConstraint(self):
        """Test AbsoluteNodeColorMultiRouteConstraint"""
