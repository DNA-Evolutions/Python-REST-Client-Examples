...
class TestOptimizationStatus(unittest.TestCase):
    """OptimizationStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OptimizationStatus:
        """Test OptimizationStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OptimizationStatus`
        """
    ...
    def testOptimizationStatus(self):
        """Test OptimizationStatus"""
