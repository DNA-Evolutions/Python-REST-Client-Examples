...
class TestDegradingLoadCapacity(unittest.TestCase):
    """DegradingLoadCapacity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DegradingLoadCapacity:
        """Test DegradingLoadCapacity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DegradingLoadCapacity`
        """
        model = DegradingLoadCapacity()
        if include_optional:
            return DegradingLoadCapacity(
                load_capacity_id = '',
                max_capacity_value = 100,
                capacity_degradation_per_stop = 1.337,
                minimal_tota_degradated_capacity = 1.337,
                type_name = 'DegradingLoadCapacity'
            )
        else:
            return DegradingLoadCapacity(
                type_name = 'DegradingLoadCapacity',
    ...
    def testDegradingLoadCapacity(self):
        """Test DegradingLoadCapacity"""
