...
class TestZoneNumber(unittest.TestCase):
    """ZoneNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ZoneNumber:
        """Test ZoneNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ZoneNumber`
        """
        model = ZoneNumber()
        if include_optional:
            return ZoneNumber(
                zone_number = 56,
                type_name = 'ZoneNumber'
            )
        else:
            return ZoneNumber(
                zone_number = 56,
