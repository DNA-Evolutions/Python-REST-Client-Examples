...
class TestAnyDefAllOfTimeDefs(unittest.TestCase):
    """AnyDefAllOfTimeDefs unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnyDefAllOfTimeDefs:
        """Test AnyDefAllOfTimeDefs
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnyDefAllOfTimeDefs`
        """
        model = AnyDefAllOfTimeDefs()
        if include_optional:
            return AnyDefAllOfTimeDefs(
                type_name = '',
                time_defs = [
                    null
                    ],
                ...
                month = 4,
                year = 2026,
                var_from = touroptimizer_py_client.models.week_day.WeekDay(),
                to = touroptimizer_py_client.models.week_day.WeekDay()
            )
        else:
            return AnyDefAllOfTimeDefs(
                type_name = '',
    ...
    def testAnyDefAllOfTimeDefs(self):
        """Test AnyDefAllOfTimeDefs"""
