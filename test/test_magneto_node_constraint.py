...
class TestMagnetoNodeConstraint(unittest.TestCase):
    """MagnetoNodeConstraint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MagnetoNodeConstraint:
        """Test MagnetoNodeConstraint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MagnetoNodeConstraint`
        """
        model = MagnetoNodeConstraint()
        if include_optional:
            return MagnetoNodeConstraint(
                node_magnet_ids = [
                    ''
                    ],
                order = 'NO_ORDER',
                type_name = 'MagnetoNode',
                is_attracting_magnet = True
            )
        else:
            return MagnetoNodeConstraint(
                node_magnet_ids = [
    ...
    def testMagnetoNodeConstraint(self):
        """Test MagnetoNodeConstraint"""
