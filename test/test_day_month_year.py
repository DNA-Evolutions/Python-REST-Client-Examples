...
class TestDayMonthYear(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DayMonthYear:
        """Test DayMonthYear
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DayMonthYear`
        """
        model = DayMonthYear()
        if include_optional:
            return DayMonthYear(
