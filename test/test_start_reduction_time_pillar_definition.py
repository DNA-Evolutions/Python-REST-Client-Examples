...
class TestStartReductionTimePillarDefinition(unittest.TestCase):
    """StartReductionTimePillarDefinition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StartReductionTimePillarDefinition:
        """Test StartReductionTimePillarDefinition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StartReductionTimePillarDefinition`
        """
        model = StartReductionTimePillarDefinition()
        if include_optional:
            return StartReductionTimePillarDefinition(
    ...
    def testStartReductionTimePillarDefinition(self):
        """Test StartReductionTimePillarDefinition"""
