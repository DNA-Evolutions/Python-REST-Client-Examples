...
class TestTypeQualification(unittest.TestCase):
    """TypeQualification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypeQualification:
        """Test TypeQualification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypeQualification`
        """
        model = TypeQualification()
        if include_optional:
    ...
    def testTypeQualification(self):
        """Test TypeQualification"""
