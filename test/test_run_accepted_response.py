...
class TestRunAcceptedResponse(unittest.TestCase):
    """RunAcceptedResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RunAcceptedResponse:
        """Test RunAcceptedResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RunAcceptedResponse`
        """
        model = RunAcceptedResponse()
        if include_optional:
            return RunAcceptedResponse(
                run_id = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
                submitted_at = 1775130148792,
                ident = 'my-optimization-run'
            )
        else:
            return RunAcceptedResponse(
        )
    ...
    def testRunAcceptedResponse(self):
        """Test RunAcceptedResponse"""
