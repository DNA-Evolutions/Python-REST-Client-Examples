...
class TestTimeWindowNodeRelation(unittest.TestCase):
    """TimeWindowNodeRelation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeWindowNodeRelation:
        """Test TimeWindowNodeRelation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeWindowNodeRelation`
        """
        model = TimeWindowNodeRelation()
        if include_optional:
            return TimeWindowNodeRelation(
                min_time_deviation = 'PT10M',
                max_time_deviation = 'PT1H',
                time_comparison_juncture = touroptimizer_py_client.models.time_comparison_juncture.TimeComparisonJuncture(
                    is_master_node_working_start = True, 
                    is_related_node_working_start = True, ),
                type_name = 'TimeWindow'
            )
        else:
            return TimeWindowNodeRelation(
                min_time_deviation = 'PT10M',
    ...
    def testTimeWindowNodeRelation(self):
        """Test TimeWindowNodeRelation"""
