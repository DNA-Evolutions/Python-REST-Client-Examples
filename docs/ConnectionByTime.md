...
------------ | ------------- | ------------- | -------------
**time_definitions** | [**List[AnyDefAllOfTimeDefs]**](AnyDefAllOfTimeDefs.md) | The timeDefinitions describe at which times, what connection should be used. | 
...
connection_by_time_from_dict = ConnectionByTime.from_dict(connection_by_time_dict)
```
