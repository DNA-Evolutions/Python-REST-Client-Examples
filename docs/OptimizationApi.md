...
------------- | ------------- | -------------
[**get_run_result**](OptimizationApi.md#get_run_result) | **GET** /api/v1/runs/{runId}/result | Retrieve the full result of a run (blocks until complete).
[**get_run_solution**](OptimizationApi.md#get_run_solution) | **GET** /api/v1/runs/{runId}/solution | Retrieve the solution of a run (blocks until complete).
[**get_started_signal**](OptimizationApi.md#get_started_signal) | **GET** /api/v1/runs/{runId}/started | Emits once the run has transitioned to the running state.
[**start_run**](OptimizationApi.md#start_run) | **POST** /api/v1/runs | Start an optimization run and return a runId.
[**stop_run**](OptimizationApi.md#stop_run) | **DELETE** /api/v1/runs/{runId} | Stop an active optimization run gracefully.
[**stream_errors**](OptimizationApi.md#stream_errors) | **GET** /api/v1/runs/{runId}/stream/errors | SSE stream of optimization errors for a run.
[**stream_progress**](OptimizationApi.md#stream_progress) | **GET** /api/v1/runs/{runId}/stream/progress | SSE stream of optimization progress for a run.
[**stream_status**](OptimizationApi.md#stream_status) | **GET** /api/v1/runs/{runId}/stream/status | SSE stream of optimization status messages for a run.
[**stream_warnings**](OptimizationApi.md#stream_warnings) | **GET** /api/v1/runs/{runId}/stream/warnings | SSE stream of optimization warnings for a run.
...
[**RunAcceptedResponse**](RunAcceptedResponse.md)
