...
conf = touroptimizer_py_client.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("touroptimizer_py_client")
    ...
    def to_debug_report(self) -> str:
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: 1.3.5-SNAPSHOT\n"\
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            {
                'url': "",
                'description': "TourOptimizer service endpoint",
            }
        ]
