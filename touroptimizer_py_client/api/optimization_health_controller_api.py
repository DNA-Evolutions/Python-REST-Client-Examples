...
class OptimizationHealthControllerApi:
    ...
    def health_status(
        ...
        _param = self._health_status_serialize(
    ...
    @validate_call
    def health_status_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
