...
class QualificationType(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'BitType': 'BitTypeQualification','BitTypeWithExpertise': 'BitTypeWithExpertiseQualification','Type': 'TypeQualification','TypeWithExpertise': 'TypeWithExpertiseQualification','UKPostCodeQualification': 'UKPostCodeQualification','ZoneNumberQualification': 'ZoneNumberQualification'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[BitTypeQualification, BitTypeWithExpertiseQualification, TypeQualification, TypeWithExpertiseQualification, UKPostCodeQualification, ZoneNumberQualification]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[BitTypeQualification, BitTypeWithExpertiseQualification, TypeQualification, TypeWithExpertiseQualification, UKPostCodeQualification, ZoneNumberQualification]]:
        """Create an instance of QualificationType from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'BitTypeQualification':
            return import_module("touroptimizer_py_client.models.bit_type_qualification").BitTypeQualification.from_dict(obj)
        if object_type ==  'BitTypeWithExpertiseQualification':
            return import_module("touroptimizer_py_client.models.bit_type_with_expertise_qualification").BitTypeWithExpertiseQualification.from_dict(obj)
        if object_type ==  'TypeQualification':
            return import_module("touroptimizer_py_client.models.type_qualification").TypeQualification.from_dict(obj)
        if object_type ==  'TypeWithExpertiseQualification':
            return import_module("touroptimizer_py_client.models.type_with_expertise_qualification").TypeWithExpertiseQualification.from_dict(obj)
        if object_type ==  'UKPostCodeQualification':
            return import_module("touroptimizer_py_client.models.uk_post_code_qualification").UKPostCodeQualification.from_dict(obj)
        if object_type ==  'ZoneNumberQualification':
            return import_module("touroptimizer_py_client.models.zone_number_qualification").ZoneNumberQualification.from_dict(obj)

        raise ValueError("QualificationType failed to lookup discriminator value from " +
