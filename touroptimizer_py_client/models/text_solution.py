...
class TextSolution(BaseModel):
    ...
    The textSolution
    """ # noqa: E501
    text_solution: StrictStr = Field(description="The textSolution", alias="textSolution")
    __properties: ClassVar[List[str]] = ["textSolution"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "textSolution": obj.get("textSolution")
        })
        return _obj
