...
class LongLongPair(BaseModel):
    ...
    """ # noqa: E501
    left: StrictInt = Field(description="The start offset value (in milliseconds).")
    right: StrictInt = Field(description="The end offset value (in milliseconds).")
