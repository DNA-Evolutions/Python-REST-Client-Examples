...
class NodeColorCapacity(BaseModel):
    """
    ...
    max_usage: Union[StrictFloat, StrictInt] = Field(description="The maximum usage ratio (0.0–1.0) of this node color within a single route. For example, 0.5 means at most 50% of the nodes on a route may carry this color.", alias="maxUsage")
    __properties: ClassVar[List[str]] = ["nodeColor", "maxUsage"]
