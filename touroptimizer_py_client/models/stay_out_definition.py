...
class StayOutDefinition(BaseModel):
    """
    ...
    """ # noqa: E501
    max_total_stays_out: StrictInt = Field(description="The maximum total number of overnight stays the resource may have across all working-hour cycles.", alias="maxTotalStaysOut")
    max_stays_out_in_row: StrictInt = Field(description="The maximum number of consecutive overnight stays in a row before the resource must return home or observe a recovery period.", alias="maxStaysOutInRow")
    min_recovery: StrictStr = Field(description="The minimum recovery duration the resource must spend at its home location before another stay-out sequence is permitted. Expressed as an ISO 8601 duration (e.g. 'PT24H' for one full day).", alias="minRecovery")
    __properties: ClassVar[List[str]] = ["maxTotalStaysOut", "maxStaysOutInRow", "minRecovery"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "maxTotalStaysOut": obj.get("maxTotalStaysOut"),
            "maxStaysOutInRow": obj.get("maxStaysOutInRow"),
            "minRecovery": obj.get("minRecovery")
        })
        return _obj
