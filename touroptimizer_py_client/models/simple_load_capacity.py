...
class SimpleLoadCapacity(ILoadCapacity):
    """
    SimpleLoadCapacity
    """ # noqa: E501
    load_capacity_id: Optional[StrictStr] = Field(default=None, alias="loadCapacityId")
    max_capacity_value: Optional[StrictInt] = Field(default=None, description="The maximum individual load capacity of this depot entry.", alias="maxCapacityValue")
    type_name: StrictStr = Field(description="The typeName of the object", alias="typeName")
    __properties: ClassVar[List[str]] = ["maximalIndividualLoadCapacity", "currentLoad", "loadPickupTime", "id", "typeName", "loadCapacityId", "maxCapacityValue"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "maximalIndividualLoadCapacity": obj.get("maximalIndividualLoadCapacity"),
            "currentLoad": obj.get("currentLoad"),
            "loadPickupTime": obj.get("loadPickupTime"),
            "id": obj.get("id"),
            "typeName": obj.get("typeName") if obj.get("typeName") is not None else 'SimpleLoadCapacity',
            "loadCapacityId": obj.get("loadCapacityId"),
            "maxCapacityValue": obj.get("maxCapacityValue")
        })
        return _obj
