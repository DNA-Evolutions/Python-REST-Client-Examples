...
class IResourceDepot(BaseModel):
    """
    ...
    """ # noqa: E501
    items: Optional[List[ILoadCapacity]] = None
    maximal_total_capacity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="maximalTotalCapacity")
    depot_id: Optional[StrictStr] = Field(default=None, alias="depotId")
    capacity_unit_map: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = Field(default=None, alias="capacityUnitMap")
    type_name: StrictStr = Field(alias="typeName")
    __properties: ClassVar[List[str]] = ["items", "maximalTotalCapacity", "depotId", "capacityUnitMap", "typeName"]
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'SimpleResourceDepot': 'SimpleResourceDepot'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[SimpleResourceDepot]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[SimpleResourceDepot]]:
        """Create an instance of IResourceDepot from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'SimpleResourceDepot':
            return import_module("touroptimizer_py_client.models.simple_resource_depot").SimpleResourceDepot.from_dict(obj)

        raise ValueError("IResourceDepot failed to lookup discriminator value from " +
