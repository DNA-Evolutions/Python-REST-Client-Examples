...
class ConstraintType(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[AbsoluteNodeColorMultiRouteConstraint, BindingResourceConstraint, ConnectedConstraint, ExcludingResourceConstraint, NodeColorMultiRouteConstraint, ResourceLocationConstraint, TypeConstraint, TypeWithExpertiseConstraint, UKPostCodeConstraint, ZoneNumberConstraint]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AbsoluteNodeColorMultiRouteConstraint, BindingResourceConstraint, ConnectedConstraint, ExcludingResourceConstraint, NodeColorMultiRouteConstraint, ResourceLocationConstraint, TypeConstraint, TypeWithExpertiseConstraint, UKPostCodeConstraint, ZoneNumberConstraint]]:
