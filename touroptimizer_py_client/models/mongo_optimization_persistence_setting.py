...
class MongoOptimizationPersistenceSetting(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["enablePersistence", "requireUniqueIdentCreatorCombination", "secret", "expiry", "optimizationPersistenceStratgySetting", "streamPersistenceStratgySetting"]
