...
class RequestFlexLoad(ILoad):
    ...
    __properties: ClassVar[List[str]] = ["priority", "loadValue", "request", "fuzzyVisit", "id", "typeName", "loadId", "isRequest", "isFuzzyVisit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "typeName": obj.get("typeName") if obj.get("typeName") is not None else 'RequestFlexLoad',
