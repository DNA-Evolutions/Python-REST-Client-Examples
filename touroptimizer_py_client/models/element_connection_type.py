...
class ElementConnectionType(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[EdgeElementConnection]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[EdgeElementConnection]]:
        """Create an instance of ElementConnectionType from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'EdgeElementConnection':
            return import_module("touroptimizer_py_client.models.edge_element_connection").EdgeElementConnection.from_dict(obj)

        raise ValueError("ElementConnectionType failed to lookup discriminator value from " +
