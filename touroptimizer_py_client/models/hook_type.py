...
class HookType(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'MaxDistanceConstructionHook': 'MaxDistanceConstructionHook'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[MaxDistanceConstructionHook]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[MaxDistanceConstructionHook]]:
        """Create an instance of HookType from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'MaxDistanceConstructionHook':
            return import_module("touroptimizer_py_client.models.max_distance_construction_hook").MaxDistanceConstructionHook.from_dict(obj)

        raise ValueError("HookType failed to lookup discriminator value from " +
