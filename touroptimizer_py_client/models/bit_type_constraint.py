...
class BitTypeConstraint(ConstraintType):
    """
    ...
    """ # noqa: E501
    type_names: List[StrictStr] = Field(description="A list of user-provided type-integer numbers. A Constraint type name must match to a Qualification type name to result in a violation free solution.", alias="typeNames")
