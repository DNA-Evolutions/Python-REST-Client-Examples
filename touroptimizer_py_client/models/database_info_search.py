...
class DatabaseInfoSearch(BaseModel):
    ...
    """ # noqa: E501
    job_id: Optional[StrictStr] = Field(default=None, description="The unique id. Can not be empty.", alias="jobId")
    ...
    __properties: ClassVar[List[str]] = ["jobId", "creator", "ident", "limit", "sortDirection", "createdDateStart", "createdDateEnd", "timeOut"]
