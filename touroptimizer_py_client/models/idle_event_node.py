...
class IdleEventNode(NodeType):
    ...
    master_id: Optional[StrictStr] = Field(default=None, description="The id of the master node that triggered the creation of this idle event (e.g. in relation-based or return-to-start scenarios).", alias="masterId")
    related_id: Optional[StrictStr] = Field(default=None, description="The id of the related node associated with this idle event (e.g. the node the resource is waiting for).", alias="relatedId")
    creation_time_stamp: Optional[StrictInt] = Field(default=None, description="The epoch-millisecond timestamp when this idle event node was created by the optimizer.", alias="creationTimeStamp")
