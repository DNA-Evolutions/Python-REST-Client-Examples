...
class WorkingHours(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["begin", "end", "zoneId", "maxTime", "maxDistance", "stayOutCycleDefinition", "startReductionTimeDefinition", "startReductionTimePillarDefinition", "startReductionTimeIncludeDefinition", "localFlexTime", "localPostFlexTime", "localPostFlexTimeOnlyOnOvertime", "maxLocalPillarAfterHoursTime", "nodeColorCapacities", "workingHoursConstraints", "multiWorkingHoursConstraints", "qualifications", "routeStartTimeHook", "hookElementConnections", "isAvailableForStay", "isClosedRoute"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.working_hours_constraints:
            for _item in self.working_hours_constraints:
                if _item:
                    _items.append(_item.to_dict())
        ...
        if self.multi_working_hours_constraints:
            for _item in self.multi_working_hours_constraints:
                if _item:
                    _items.append(_item.to_dict())
        ...
        if self.hook_element_connections:
            for _item in self.hook_element_connections:
                if _item:
                    _items.append(_item.to_dict())
