...
class WorkingHours(BaseModel):
    ...
    is_local_service_hub: Optional[StrictBool] = Field(default=False, description="A resource is hub mode gets visited by nodes on this particular working horus.", alias="isLocalServiceHub")
    ...
    __properties: ClassVar[List[str]] = ["begin", "end", "zoneId", "maxTime", "maxDistance", "stayOutCycleDefinition", "startReductionTimeDefinition", "startReductionTimePillarDefinition", "startReductionTimeIncludeDefinition", "localFlexTime", "localPostFlexTime", "localPostFlexTimeOnlyOnOvertime", "maxLocalPillarAfterHoursTime", "nodeColorCapacities", "workingHoursConstraints", "multiWorkingHoursConstraints", "constructionHooks", "qualifications", "routeStartTimeHook", "hookElementConnections", "isLocalServiceHub", "isAvailableForStay", "isClosedRoute"]
