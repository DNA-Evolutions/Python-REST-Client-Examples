...
class ConstructionOptimizationAlgorithmConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["algorithm"]

    @field_validator('algorithm')
    def algorithm_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SIMULTANEOUS_SPACE_SAVINGS_ALGO', 'PICKY_SIMULTANEOUS_SPACE_SAVINGS_ALGO', 'SEQUENTIAL_SPACE_SAVINGS_ALGO', 'CLUSTERED_SEQUENTIAL_SPACE_SAVINGS_ALGO', 'CLUSTERED_SEQUENTIAL_SPACE_SAVINGS_WITH_REASSIGNMENT_ALGO', 'FULL_ASSIGNMENT_BASED_ALGO', 'CLUSTERED_MULTI_LAYER_SEQUENTIAL_SPACE_SAVINGS_ALGO', 'SMART_CONSTR_ALGO']):
            raise ValueError("must be one of enum values ('SIMULTANEOUS_SPACE_SAVINGS_ALGO', 'PICKY_SIMULTANEOUS_SPACE_SAVINGS_ALGO', 'SEQUENTIAL_SPACE_SAVINGS_ALGO', 'CLUSTERED_SEQUENTIAL_SPACE_SAVINGS_ALGO', 'CLUSTERED_SEQUENTIAL_SPACE_SAVINGS_WITH_REASSIGNMENT_ALGO', 'FULL_ASSIGNMENT_BASED_ALGO', 'CLUSTERED_MULTI_LAYER_SEQUENTIAL_SPACE_SAVINGS_ALGO', 'SMART_CONSTR_ALGO')")
        return value
