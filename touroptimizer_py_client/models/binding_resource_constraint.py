...
class BindingResourceConstraint(ConstraintType):
    """
    ...
    """ # noqa: E501
    resources: List[ResourceWithPriority] = Field(description="The resources that can be choosen to visit a certain node.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "typeName": obj.get("typeName") if obj.get("typeName") is not None else 'BindingResource',
