...
class TypeWithExpertiseQualification(QualificationType):
    """
    ...
    """ # noqa: E501
    types_with_expertise: List[TypeWithExpertise] = Field(description="A list of user-provided type-names and expertise levels. A Constraint type-name with its required expertise must be fulfill by the type-with-expertise Qualification to result in a violation free solution.", alias="typesWithExpertise")
    type_name: StrictStr = Field(description="The typeName of the object", alias="typeName")
    __properties: ClassVar[List[str]] = ["typeName", "typesWithExpertise"]
