...
class TypeWithExpertise(BaseModel):
    """
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="The type name that in addition requires a certain expertise level.")
    level: Union[StrictFloat, StrictInt] = Field(description="The expertise level")
    is_min: StrictBool = Field(description="The boolean isMin. If isMin==true, the level is a minimal level that needs to be fulfilled.", alias="isMin")
    __properties: ClassVar[List[str]] = ["type", "level", "isMin"]
