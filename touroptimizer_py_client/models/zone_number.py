...
class ZoneNumber(ZoneCodeType):
    ...
    """ # noqa: E501
    zone_number: StrictInt = Field(description="The numeric zone identifier assigned to this element. Zone numbers are used to define geographic territories for resources and to penalize or restrict zone crossings between nodes via ZoneConnections.", alias="zoneNumber")
    type_name: StrictStr = Field(description="The typeName of the object", alias="typeName")
    __properties: ClassVar[List[str]] = ["typeName", "zoneNumber"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "typeName": obj.get("typeName") if obj.get("typeName") is not None else 'ZoneNumber',
            "zoneNumber": obj.get("zoneNumber")
        })
        return _obj
