...
class StartReductionTimeIncludeDefinition(BaseModel):
    """
    The settings/defintion for how to handle working time in the context of reduction time.
    """ # noqa: E501
    is_reduction_time_included_in_working_time: StrictBool = Field(description="The boolean isReductionTimeIncludedInWorkingTime. If reduction time is used it can be either counted as part of the working time or not.", alias="isReductionTimeIncludedInWorkingTime")
    __properties: ClassVar[List[str]] = ["isReductionTimeIncludedInWorkingTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "isReductionTimeIncludedInWorkingTime": obj.get("isReductionTimeIncludedInWorkingTime")
        })
        return _obj
