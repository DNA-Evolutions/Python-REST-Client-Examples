...
class ILoadCapacity(BaseModel):
    """
    The LoadCapacity type
    """ # noqa: E501
    maximal_individual_load_capacity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="maximalIndividualLoadCapacity")
    current_load: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="currentLoad")
    load_pickup_time: Optional[StrictInt] = Field(default=None, alias="loadPickupTime")
    id: Optional[StrictStr] = None
    type_name: StrictStr = Field(alias="typeName")
    __properties: ClassVar[List[str]] = ["maximalIndividualLoadCapacity", "currentLoad", "loadPickupTime", "id", "typeName"]
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'DegradingLoadCapacity': 'DegradingLoadCapacity','SimpleLoadCapacity': 'SimpleLoadCapacity'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[DegradingLoadCapacity, SimpleLoadCapacity]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[DegradingLoadCapacity, SimpleLoadCapacity]]:
        """Create an instance of ILoadCapacity from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'DegradingLoadCapacity':
            return import_module("touroptimizer_py_client.models.degrading_load_capacity").DegradingLoadCapacity.from_dict(obj)
        if object_type ==  'SimpleLoadCapacity':
            return import_module("touroptimizer_py_client.models.simple_load_capacity").SimpleLoadCapacity.from_dict(obj)

        raise ValueError("ILoadCapacity failed to lookup discriminator value from " +
