...
class OptimizationKeySetting(BaseModel):
    """
    The keySetting
    """ # noqa: E501
    json_license: Optional[StrictStr] = Field(default=None, description="The jsonLicense", alias="jsonLicense")
    __properties: ClassVar[List[str]] = ["jsonLicense"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jsonLicense": obj.get("jsonLicense")
        })
        return _obj
