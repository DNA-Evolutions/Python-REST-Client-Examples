...
class StayOutCycleDefinition(BaseModel):
    ...
    """ # noqa: E501
    cycle_lenght: StrictStr = Field(description="The cycleLenght", alias="cycleLenght")
    cycle_start: date = Field(description="The cycleStart", alias="cycleStart")
    __properties: ClassVar[List[str]] = ["cycleLenght", "cycleStart"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cycleLenght": obj.get("cycleLenght"),
