...
class StayOutCycleDefinition(BaseModel):
    """
    ...
    """ # noqa: E501
    cycle_length: StrictStr = Field(description="The length of one stay-out evaluation cycle, expressed as an ISO 8601 duration (e.g. 'PT7D' for one week).", alias="cycleLength")
    cycle_start: date = Field(description="The start date of the first stay-out evaluation cycle. Subsequent cycles begin at cycleStart + N * cycleLength.", alias="cycleStart")
    __properties: ClassVar[List[str]] = ["cycleLength", "cycleStart"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cycleLength": obj.get("cycleLength"),
