...
class RunAcceptedResponse(BaseModel):
    ...
    """ # noqa: E501
    run_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for this run. Use with GET /api/v1/runs/{runId}/result to retrieve the result and GET /api/v1/runs/{runId}/stream/* for live events.", alias="runId")
    submitted_at: Optional[StrictInt] = Field(default=None, description="Epoch-millisecond timestamp when the run was accepted.", alias="submittedAt")
    ident: Optional[StrictStr] = Field(default=None, description="User-defined label echoed back from the input ident field.")
    __properties: ClassVar[List[str]] = ["runId", "submittedAt", "ident"]
