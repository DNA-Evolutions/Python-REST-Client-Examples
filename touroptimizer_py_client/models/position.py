...
class Position(BaseModel):
    ...
    location_id: Optional[StrictStr] = Field(default=None, description="An optional location identifier that links this position to a shared location. Elements with the same locationId share the same geographic coordinates and connection data, reducing input size.", alias="locationId")
