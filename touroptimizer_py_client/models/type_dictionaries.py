...
class TypeDictionaries(BaseModel):
    """
    ...
    """ # noqa: E501
    type_dictionaries: Optional[List[TypeDictionary]] = Field(default=None, description="The optional list of typeDictionaries", alias="typeDictionaries")
    __properties: ClassVar[List[str]] = ["typeDictionaries"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in type_dictionaries (list)
        _items = []
        if self.type_dictionaries:
            for _item_type_dictionaries in self.type_dictionaries:
                if _item_type_dictionaries:
                    _items.append(_item_type_dictionaries.to_dict())
            _dict['typeDictionaries'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "typeDictionaries": [TypeDictionary.from_dict(_item) for _item in obj["typeDictionaries"]] if obj.get("typeDictionaries") is not None else None
        })
        return _obj
