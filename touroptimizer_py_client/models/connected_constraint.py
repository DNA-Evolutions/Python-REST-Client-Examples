...
class ConnectedConstraint(ConstraintType):
    ...
    connection_type: StrictStr = Field(description="The logical operator connecting constraintOne and constraintTwo. Defines whether both must be satisfied (AND) or at least one (OR).", alias="connectionType")
