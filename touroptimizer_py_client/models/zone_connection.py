...
class ZoneConnection(BaseModel):
    ...
    """ # noqa: E501
    from_zone_id: StrictStr = Field(description="The zone that is left.", alias="fromZoneId")
    to_zone_id: StrictStr = Field(description="The zone that is entered.", alias="toZoneId")
    crossing_penalty_multiplier: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The crossingPenaltyMultiplier when going fromZoneId to toZoneId", alias="crossingPenaltyMultiplier")
    __properties: ClassVar[List[str]] = ["fromZoneId", "toZoneId", "crossingPenaltyMultiplier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fromZoneId": obj.get("fromZoneId"),
            "toZoneId": obj.get("toZoneId"),
            "crossingPenaltyMultiplier": obj.get("crossingPenaltyMultiplier")
        })
        return _obj
