...
class BitTypeWithExpertiseQualification(QualificationType):
    """
    ...
    dict_mapping: Optional[Dict[str, TypeLevelOffering]] = Field(default=None, description="The mapping of a certain type. or multiple types", alias="dictMapping")
    type_name: StrictStr = Field(description="The typeName of the object", alias="typeName")
    __properties: ClassVar[List[str]] = ["typeName", "dictTypeNames", "dictMapping"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dictMapping": dict(
                (_k, TypeLevelOffering.from_dict(_v))
