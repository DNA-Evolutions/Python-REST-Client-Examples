...
class SimpleNodeDepot(INodeDepot):
    """
    SimpleNodeDepot
    """ # noqa: E501
    type_name: StrictStr = Field(description="The typeName of the object", alias="typeName")
    __properties: ClassVar[List[str]] = ["items", "depotId", "typeName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ILoad.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "depotId": obj.get("depotId"),
            "typeName": obj.get("typeName") if obj.get("typeName") is not None else 'SimpleNodeDepot'
        })
        return _obj
