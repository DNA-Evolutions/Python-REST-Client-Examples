...
class OptimizationPersistenceSetting(BaseModel):
    """
    The persistenceSetting
    """ # noqa: E501
    mongo_settings: Optional[MongoOptimizationPersistenceSetting] = Field(default=None, alias="mongoSettings")
    __properties: ClassVar[List[str]] = ["mongoSettings"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of mongo_settings
        if self.mongo_settings:
            _dict['mongoSettings'] = self.mongo_settings.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mongoSettings": MongoOptimizationPersistenceSetting.from_dict(obj["mongoSettings"]) if obj.get("mongoSettings") is not None else None
        })
        return _obj
