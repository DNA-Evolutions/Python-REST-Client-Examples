...
class Solution(BaseModel):
    ...
    created_time_stamp: Optional[StrictInt] = Field(default=None, description="A timestamp the Snapshot was created that will automatically filled out, if neccessary", alias="createdTimeStamp")
    creator: Optional[StrictStr] = Field(default=None, description="An id related to the creator that is filled out autmatically")
    ident: Optional[StrictStr] = Field(default=None, description="An optional title/ident inhertited from the OptimizationCondig.")
    header: Optional[SolutionHeader] = None
    routes: List[Route] = Field(description="The routes of the solution.")
    __properties: ClassVar[List[str]] = ["optimizationStatus", "id", "createdTimeStamp", "creator", "ident", "header", "routes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ident": obj.get("ident"),
            "header": SolutionHeader.from_dict(obj["header"]) if obj.get("header") is not None else None,
