...
class PluginSettings(BaseModel):
    ...
    The PluginSettings
    """ # noqa: E501
    plugins: List[PluginSetting] = Field(description="The plugins")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "plugins": [PluginSetting.from_dict(_item) for _item in obj["plugins"]] if obj.get("plugins") is not None else None
        })
        return _obj
