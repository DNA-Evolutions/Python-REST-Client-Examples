...
class UKPostCode(ZoneCodeType):
    ...
    """ # noqa: E501
    area_ident: StrictStr = Field(description="The area identifier of the UK postcode (e.g. 'SW', 'EC', 'M'). This is the outward code's letter prefix that identifies the postal area.", alias="areaIdent")
    district_ident_opt: Optional[StrictInt] = Field(default=None, description="The optional district number within the postal area (e.g. 1 in 'SW1').", alias="districtIdentOpt")
    sector_ident_opt: Optional[StrictInt] = Field(default=None, description="The optional sector number from the inward code (e.g. 4 in 'SW1A 4').", alias="sectorIdentOpt")
    unit_ident_opt: Optional[StrictStr] = Field(default=None, description="The optional unit identifier from the inward code (e.g. 'AA' in 'SW1A 4AA').", alias="unitIdentOpt")
    type_name: StrictStr = Field(description="The typeName of the object", alias="typeName")
    __properties: ClassVar[List[str]] = ["typeName", "areaIdent", "districtIdentOpt", "sectorIdentOpt", "unitIdentOpt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "typeName": obj.get("typeName") if obj.get("typeName") is not None else 'UKPostCode',
            "areaIdent": obj.get("areaIdent"),
            "districtIdentOpt": obj.get("districtIdentOpt"),
            "sectorIdentOpt": obj.get("sectorIdentOpt"),
            "unitIdentOpt": obj.get("unitIdentOpt")
        })
        return _obj
