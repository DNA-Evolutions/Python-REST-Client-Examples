...
class UKPostCode(ZoneCodeType):
    ...
    UKPostCode
    """ # noqa: E501
    area_ident: StrictStr = Field(description="The areaIdent", alias="areaIdent")
    district_ident_opt: Optional[StrictInt] = Field(default=None, description="The districtIdentOpt", alias="districtIdentOpt")
    sector_ident_opt: Optional[StrictInt] = Field(default=None, description="The sectorIdentOpt", alias="sectorIdentOpt")
    unit_ident_opt: Optional[StrictStr] = Field(default=None, description="The unitIdentOpt", alias="unitIdentOpt")
