...
class UKPostCodeQualification(QualificationType):
    """
    ...
    """ # noqa: E501
    my_code: ZoneCodeType = Field(alias="myCode")
    my_extra_codes: Optional[List[ZoneCodeType]] = Field(default=None, description="Additional UK postcodes this resource is also qualified to serve, beyond the primary code.", alias="myExtraCodes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "typeName": obj.get("typeName") if obj.get("typeName") is not None else 'UKPostCodeQualification',
