...
class GeoAddress(BaseModel):
    ...
    """ # noqa: E501
    location_id: Optional[StrictStr] = Field(default=None, description="An optional identifier linking this address to a shared location entry.", alias="locationId")
    housenumber: Optional[StrictStr] = Field(default=None, description="The house number of the address.")
    streetname: Optional[StrictStr] = Field(default=None, description="The street name of the address (without house number).")
    city: Optional[StrictStr] = Field(default=None, description="The city or locality name.")
    county: Optional[StrictStr] = Field(default=None, description="The county or administrative district.")
    state: Optional[StrictStr] = Field(default=None, description="The state or region name.")
    statecode: Optional[StrictStr] = Field(default=None, description="The state or region code (abbreviated form, e.g. 'NSW', 'BY').")
    country: Optional[StrictStr] = Field(default=None, description="The country name (e.g. 'Germany', 'Australia').")
    macrocountry: Optional[StrictStr] = Field(default=None, description="The macro-country or metropolitan region (e.g. 'Berlin', 'Sydney').")
    countrycode: Optional[StrictStr] = Field(default=None, description="The country code (ISO CODE)")
    postalcode: Optional[StrictStr] = Field(default=None, description="The postal or ZIP code.")
    layer: Optional[StrictStr] = Field(default=None, description="The geocoding layer (e.g. 'address', 'venue', 'street') indicating the granularity of the match.")
    source: Optional[StrictStr] = Field(default=None, description="The geocoding data source (e.g. 'openstreetmap', 'geonames') that provided this address.")
    accuracy: Optional[StrictStr] = Field(default=None, description="The accuracy level of the geocoding result (e.g. 'point', 'centroid', 'interpolated').")
    ...
    label: Optional[StrictStr] = Field(default=None, description="A fully formatted address label combining all available components (e.g. '495 Old South Head Road, Rose Bay, NSW, Australia').")
