...
class NodeRelationType(BaseModel):
    """
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'DifferentVisitor': 'DifferentVisitorNodeRelation','MultiTimeWindow': 'MultiTimeWindowNodeRelation','SameVisitor': 'SameVisitorNodeRelation','TimeWindow': 'TimeWindowNodeRelation'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[DifferentVisitorNodeRelation, MultiTimeWindowNodeRelation, SameVisitorNodeRelation, TimeWindowNodeRelation]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[DifferentVisitorNodeRelation, MultiTimeWindowNodeRelation, SameVisitorNodeRelation, TimeWindowNodeRelation]]:
        """Create an instance of NodeRelationType from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'DifferentVisitorNodeRelation':
            return import_module("touroptimizer_py_client.models.different_visitor_node_relation").DifferentVisitorNodeRelation.from_dict(obj)
        if object_type ==  'MultiTimeWindowNodeRelation':
            return import_module("touroptimizer_py_client.models.multi_time_window_node_relation").MultiTimeWindowNodeRelation.from_dict(obj)
        if object_type ==  'SameVisitorNodeRelation':
            return import_module("touroptimizer_py_client.models.same_visitor_node_relation").SameVisitorNodeRelation.from_dict(obj)
        if object_type ==  'TimeWindowNodeRelation':
            return import_module("touroptimizer_py_client.models.time_window_node_relation").TimeWindowNodeRelation.from_dict(obj)

        raise ValueError("NodeRelationType failed to lookup discriminator value from " +
