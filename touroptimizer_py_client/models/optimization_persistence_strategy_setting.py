...
class OptimizationPersistenceStrategySetting(BaseModel):
    """
    The optimizationPersistenceStrategySetting
    """ # noqa: E501
    save_connections: Optional[StrictBool] = Field(default=None, description="The saveConnections. Only takes action if saveOnlyResult is false.", alias="saveConnections")
    __properties: ClassVar[List[str]] = ["saveConnections"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "saveConnections": obj.get("saveConnections")
        })
        return _obj
