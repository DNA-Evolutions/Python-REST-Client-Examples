...
class WeekDay(DateDef):
    """
    Matches a specific day of the week (1 = Monday … 7 = Sunday, ISO-8601).
    """ # noqa: E501
    day: Optional[Annotated[int, Field(le=7, strict=True, ge=1)]] = Field(default=None, description="ISO-8601 day of the week (1 = Monday, 7 = Sunday).")
    __properties: ClassVar[List[str]] = ["typeName", "day"]
