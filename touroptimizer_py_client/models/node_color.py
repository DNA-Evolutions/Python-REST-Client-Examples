...
class NodeColor(BaseModel):
    ...
    """ # noqa: E501
    color_code: StrictInt = Field(description="A numeric color code identifying this color category. Must match the codes used in NodeColorCapacity constraints.", alias="colorCode")
    color_id: StrictStr = Field(description="A human-readable identifier for this color category (e.g. 'HAZARDOUS', 'PRIORITY_A', 'COLD_CHAIN').", alias="colorId")
    count_value: Optional[StrictInt] = Field(default=None, description="The contribution count of this node towards its color category. Defaults to 1. A higher value means this node 'consumes' more of the route's color capacity budget.", alias="countValue")
    __properties: ClassVar[List[str]] = ["colorCode", "colorId", "countValue"]
