...
class DayMonthYear(DateDef):
    """
    Matches a specific date (year, month, day).
    """ # noqa: E501
    year: Optional[StrictInt] = Field(default=None, description="Year.")
    month: Optional[Annotated[int, Field(le=12, strict=True, ge=1)]] = Field(default=None, description="Month of the year (1–12).")
    day: Optional[Annotated[int, Field(le=31, strict=True, ge=1)]] = Field(default=None, description="Day of the month (1–31).")
    __properties: ClassVar[List[str]] = ["typeName", "year", "month", "day"]
