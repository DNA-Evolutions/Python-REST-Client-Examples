...
class GeoNode(NodeType):
    ...
    """ # noqa: E501
    position: Position
    pillar_node: Optional[GeoPillarNode] = Field(default=None, alias="pillarNode")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pillarNode": GeoPillarNode.from_dict(obj["pillarNode"]) if obj.get("pillarNode") is not None else None
        })
        return _obj
