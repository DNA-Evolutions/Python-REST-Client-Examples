...
class DatabaseEncryptedItemSearch(BaseModel):
    """
    ...
    secret: Optional[StrictStr] = Field(default=None, description="An optional password for encryption. Can not be empty.")
    __properties: ClassVar[List[str]] = ["creator", "id", "timeOut", "secret"]
