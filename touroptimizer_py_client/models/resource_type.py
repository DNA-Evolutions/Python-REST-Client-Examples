...
class ResourceType(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[CapacityResource]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[CapacityResource]]:
        """Create an instance of ResourceType from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'CapacityResource':
            return import_module("touroptimizer_py_client.models.capacity_resource").CapacityResource.from_dict(obj)
