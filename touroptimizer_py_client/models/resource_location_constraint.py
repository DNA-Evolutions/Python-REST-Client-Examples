...
class ResourceLocationConstraint(ConstraintType):
    """
    ...
    """ # noqa: E501
    max_radius_distance: Optional[StrictStr] = Field(default=None, description="The maximum Euclidean or road-network distance a resource may be located from this node in order to be eligible to visit it. If omitted, only maxRadiusTime is enforced.", alias="maxRadiusDistance")
    max_radius_time: Optional[StrictStr] = Field(default=None, description="The maximum travel time a resource may need to reach this node in order to be eligible to visit it. If omitted, only maxRadiusDistance is enforced.", alias="maxRadiusTime")
    type_name: StrictStr = Field(description="The typeName of the object", alias="typeName")
    __properties: ClassVar[List[str]] = ["typeName", "maxRadiusDistance", "maxRadiusTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "typeName": obj.get("typeName") if obj.get("typeName") is not None else 'ResourceLocationConstraint',
            "maxRadiusDistance": obj.get("maxRadiusDistance"),
            "maxRadiusTime": obj.get("maxRadiusTime")
        })
        return _obj
