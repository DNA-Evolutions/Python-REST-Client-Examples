...
class OfferedNode(BaseModel):
    ...
    """ # noqa: E501
    individual_multiplier: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The cost multiplier for an offered node. If the multiplier is bigger than 1.0 the chances that the node shows violations is getting less.", alias="individualMultiplier")
    __properties: ClassVar[List[str]] = ["individualMultiplier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "individualMultiplier": obj.get("individualMultiplier")
        })
        return _obj
