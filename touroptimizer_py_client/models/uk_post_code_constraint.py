...
class UKPostCodeConstraint(ConstraintType):
    """
    ...
    """ # noqa: E501
    zone_codes: List[ZoneCodeType] = Field(description="The list of UK postcode zone codes that a resource must be qualified for to visit this node.", alias="zoneCodes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "typeName": obj.get("typeName") if obj.get("typeName") is not None else 'UKPostCodeConstraint',
