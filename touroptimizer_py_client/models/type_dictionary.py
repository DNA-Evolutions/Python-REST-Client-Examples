...
class TypeDictionary(BaseModel):
    """
    The optional list of typeDictionaries
    """ # noqa: E501
    mapping: Dict[str, StrictStr] = Field(description="The mapping of a certain type. or multiple types")
    type_names: List[StrictStr] = Field(description="List of type names this dictionary applies to.", alias="typeNames")
    __properties: ClassVar[List[str]] = ["mapping", "typeNames"]
