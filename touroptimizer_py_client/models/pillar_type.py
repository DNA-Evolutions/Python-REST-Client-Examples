...
class PillarType(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'EventPillarNode': 'EventPillarNode','GeoPillarNode': 'GeoPillarNode'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[EventPillarNode, GeoPillarNode]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[EventPillarNode, GeoPillarNode]]:
        """Create an instance of PillarType from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'EventPillarNode':
            return import_module("touroptimizer_py_client.models.event_pillar_node").EventPillarNode.from_dict(obj)
        if object_type ==  'GeoPillarNode':
            return import_module("touroptimizer_py_client.models.geo_pillar_node").GeoPillarNode.from_dict(obj)

        raise ValueError("PillarType failed to lookup discriminator value from " +
