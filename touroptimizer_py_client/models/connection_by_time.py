...
class ConnectionByTime(BaseModel):
    ...
    """ # noqa: E501
    time_definitions: List[Any] = Field(description="The timeDefinitions describe at which times, what connection should be used.", alias="timeDefinitions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "timeDefinitions": obj.get("timeDefinitions"),
