...
class ConnectionByTime(BaseModel):
    ...
    """ # noqa: E501
    time_definitions: List[AnyDefAllOfTimeDefs] = Field(description="The timeDefinitions describe at which times, what connection should be used.", alias="timeDefinitions")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.time_definitions:
            for _item_time_definitions in self.time_definitions:
                if _item_time_definitions:
                    _items.append(_item_time_definitions.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "timeDefinitions": [AnyDefAllOfTimeDefs.from_dict(_item) for _item in obj["timeDefinitions"]] if obj.get("timeDefinitions") is not None else None,
