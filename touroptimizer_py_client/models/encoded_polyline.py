...
class EncodedPolyline(BaseModel):
    """
    ...
    """ # noqa: E501
    encoded_polyline: StrictStr = Field(description="An encoded polyline (see e.g.: https://developers.google.com/maps/documentation/utilities/polylinealgorithm).", alias="encodedPolyline")
    precision: Union[StrictFloat, StrictInt] = Field(description="The precision of the encoded polyline.")
    __properties: ClassVar[List[str]] = ["encodedPolyline", "precision"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "encodedPolyline": obj.get("encodedPolyline"),
