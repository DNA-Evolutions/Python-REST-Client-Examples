...
class JOptOptimizationProgress(BaseModel):
    ...
    job_id: StrictStr = Field(description="The jobId id. Will be filled out by the optimizer, if necessary", alias="jobId")
    tenant_id: StrictStr = Field(description="The tenant id of the creator started this job.", alias="tenantId")
    ...
    __properties: ClassVar[List[str]] = ["id", "jobId", "tenantId", "creator", "ident", "callerId", "curProgress", "curCost", "stage", "desc", "expireAt"]
