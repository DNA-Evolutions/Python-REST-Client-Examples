...
class CoreBuildOptions(BaseModel):
    """
    ...
    """ # noqa: E501
    build_core_properties: Dict[str, StrictStr] = Field(description="The properties of the Optimization run. For example, the number of iterations for the Optimization run or the weight for certain Optimization goals can be defined.", alias="buildCoreProperties")
    __properties: ClassVar[List[str]] = ["buildCoreProperties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "buildCoreProperties": obj.get("buildCoreProperties")
        })
        return _obj
