...
class StringIntegerPair(BaseModel):
    """
    ...
    """ # noqa: E501
    left: StrictStr = Field(description="A string key, typically a node or element identifier.")
    right: StrictInt = Field(description="An integer value associated with the key (e.g. a count, index, or capacity value).")
