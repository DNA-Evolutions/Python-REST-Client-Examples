...
class ExcludingResourceConstraint(ConstraintType):
    """
    ...
    """ # noqa: E501
    resources: List[ResourceWithPriority] = Field(description="The list of resources that should NOT visit a certain node.")
    type_name: StrictStr = Field(description="The typeName of the object", alias="typeName")
    __properties: ClassVar[List[str]] = ["typeName", "resources"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "typeName": obj.get("typeName") if obj.get("typeName") is not None else 'ExcludingResource',
            "resources": [ResourceWithPriority.from_dict(_item) for _item in obj["resources"]] if obj.get("resources") is not None else None
        })
        return _obj
