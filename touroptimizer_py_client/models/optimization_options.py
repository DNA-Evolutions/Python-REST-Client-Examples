...
class OptimizationOptions(BaseModel):
    ...
    """ # noqa: E501
    properties: Dict[str, StrictStr] = Field(description="The properties of the Optimization run. For example, the number of iterations for the Optimization run or the weight for certain Optimization goals can be defined.")
    optimization_scheme_options: Optional[OptimizationSchemeOptions] = Field(default=None, alias="optimizationSchemeOptions")
    __properties: ClassVar[List[str]] = ["properties", "optimizationSchemeOptions"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of optimization_scheme_options
        if self.optimization_scheme_options:
            _dict['optimizationSchemeOptions'] = self.optimization_scheme_options.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "optimizationSchemeOptions": OptimizationSchemeOptions.from_dict(obj["optimizationSchemeOptions"]) if obj.get("optimizationSchemeOptions") is not None else None
        })
        return _obj
