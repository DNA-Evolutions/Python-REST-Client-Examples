...
class NodeColorMultiRouteConstraint(ConstraintType):
    ...
    node_color_capacities: List[NodeColorCapacity] = Field(description="The per-color capacity limits (ratio-based) enforced by this multi-route constraint.", alias="nodeColorCapacities")
