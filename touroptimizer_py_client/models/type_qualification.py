...
class TypeQualification(QualificationType):
    """
    ...
    """ # noqa: E501
    type_names: List[StrictStr] = Field(description="A list of user-provided type-names. A Constraint type name must match to a Qualification type name to result in a violation free solution.", alias="typeNames")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "typeName": obj.get("typeName") if obj.get("typeName") is not None else 'Type',
