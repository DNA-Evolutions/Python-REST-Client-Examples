...
class OptimizationPersistenceStratgySetting(BaseModel):
    """
    The optimizationPersistenceStratgySetting
    """ # noqa: E501
    save_only_result: StrictBool = Field(description="The saveOnlyResult", alias="saveOnlyResult")
    ...
    __properties: ClassVar[List[str]] = ["saveOnlyResult", "saveConnections"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "saveOnlyResult": obj.get("saveOnlyResult"),
