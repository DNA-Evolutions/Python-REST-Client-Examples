...
class DegradingLoadCapacity(ILoadCapacity):
    """
    ...
    capacity_degradation_per_stop: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="capacityDegradationPerStop")
    minimal_tota_degradated_capacity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="minimalTotaDegradatedCapacity")
    type_name: StrictStr = Field(description="The typeName of the object", alias="typeName")
    __properties: ClassVar[List[str]] = ["maximalIndividualLoadCapacity", "currentLoad", "loadPickupTime", "id", "typeName", "loadCapacityId", "maxCapacityValue", "capacityDegradationPerStop", "minimalTotaDegradatedCapacity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "typeName": obj.get("typeName") if obj.get("typeName") is not None else 'DegradingLoadCapacity',
            "loadCapacityId": obj.get("loadCapacityId"),
            "maxCapacityValue": obj.get("maxCapacityValue"),
            "capacityDegradationPerStop": obj.get("capacityDegradationPerStop"),
            "minimalTotaDegradatedCapacity": obj.get("minimalTotaDegradatedCapacity")
        })
        return _obj
