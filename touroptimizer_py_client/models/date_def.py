...
class DateDef(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'Any': 'AnyDef','Day': 'Day','DayMonth': 'DayMonth','DayMonthYear': 'DayMonthYear','Range.Day': 'RangeDay','Range.DayMonth': 'RangeDayMonth','Range.DayMonthYear': 'RangeDayMonthYear','Range.WeekDay': 'RangeWeekDay','WeekDay': 'WeekDay'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[AnyDef, Day, DayMonth, DayMonthYear, RangeDay, RangeDayMonth, RangeDayMonthYear, RangeWeekDay, WeekDay]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AnyDef, Day, DayMonth, DayMonthYear, RangeDay, RangeDayMonth, RangeDayMonthYear, RangeWeekDay, WeekDay]]:
        """Create an instance of DateDef from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'AnyDef':
            return import_module("touroptimizer_py_client.models.any_def").AnyDef.from_dict(obj)
        if object_type ==  'Day':
            return import_module("touroptimizer_py_client.models.day").Day.from_dict(obj)
        if object_type ==  'DayMonth':
            return import_module("touroptimizer_py_client.models.day_month").DayMonth.from_dict(obj)
        if object_type ==  'DayMonthYear':
            return import_module("touroptimizer_py_client.models.day_month_year").DayMonthYear.from_dict(obj)
        if object_type ==  'RangeDay':
            return import_module("touroptimizer_py_client.models.range_day").RangeDay.from_dict(obj)
        if object_type ==  'RangeDayMonth':
            return import_module("touroptimizer_py_client.models.range_day_month").RangeDayMonth.from_dict(obj)
        if object_type ==  'RangeDayMonthYear':
            return import_module("touroptimizer_py_client.models.range_day_month_year").RangeDayMonthYear.from_dict(obj)
        if object_type ==  'RangeWeekDay':
            return import_module("touroptimizer_py_client.models.range_week_day").RangeWeekDay.from_dict(obj)
        if object_type ==  'WeekDay':
            return import_module("touroptimizer_py_client.models.week_day").WeekDay.from_dict(obj)

        raise ValueError("DateDef failed to lookup discriminator value from " +
