...
class AbsoluteNodeColorCapacity(BaseModel):
    """
    The per-color capacity limits (absolute count-based) enforced by this multi-route constraint.
    """ # noqa: E501
    node_color: NodeColor = Field(alias="nodeColor")
    min_usage: StrictInt = Field(description="The minimum number of nodes of this color that must appear on a route for the constraint to be satisfied.", alias="minUsage")
    max_usage: StrictInt = Field(description="The maximum number of nodes of this color permitted on a single route.", alias="maxUsage")
    __properties: ClassVar[List[str]] = ["nodeColor", "minUsage", "maxUsage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "minUsage": obj.get("minUsage"),
            "maxUsage": obj.get("maxUsage")
        })
        return _obj
