...
class AbsoluteNodeColorCapacity(BaseModel):
    ...
    min_usage: StrictInt = Field(description="The minUsage  of the AbsoluteNodeColorCapacity", alias="minUsage")
    max_usage: StrictInt = Field(description="The maxUsage  of the AbsoluteNodeColorCapacity", alias="maxUsage")
