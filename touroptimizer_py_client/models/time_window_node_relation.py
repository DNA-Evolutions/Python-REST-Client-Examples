...
class TimeWindowNodeRelation(NodeRelationType):
    """
    ...
    """ # noqa: E501
    min_time_deviation: StrictStr = Field(description="The minTimeDeviation defines the minimal time of the relation.", alias="minTimeDeviation")
    max_time_deviation: StrictStr = Field(description="The maxTimeDeviation defines the minimal time of the relation.", alias="maxTimeDeviation")
    time_comparison_juncture: Optional[TimeComparisonJuncture] = Field(default=None, alias="timeComparisonJuncture")
    type_name: StrictStr = Field(description="The typeName of the object", alias="typeName")
    __properties: ClassVar[List[str]] = ["typeName", "minTimeDeviation", "maxTimeDeviation", "timeComparisonJuncture"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of time_comparison_juncture
        if self.time_comparison_juncture:
            _dict['timeComparisonJuncture'] = self.time_comparison_juncture.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "typeName": obj.get("typeName") if obj.get("typeName") is not None else 'TimeWindow',
            "minTimeDeviation": obj.get("minTimeDeviation"),
            "maxTimeDeviation": obj.get("maxTimeDeviation"),
            "timeComparisonJuncture": TimeComparisonJuncture.from_dict(obj["timeComparisonJuncture"]) if obj.get("timeComparisonJuncture") is not None else None
        })
        return _obj
