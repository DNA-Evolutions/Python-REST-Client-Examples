...
class OptimizationStatus(BaseModel):
    ...
    """ # noqa: E501
    status_description: StrictStr = Field(description="The description of status of the optimization", alias="statusDescription")
    error: StrictStr = Field(description="An  error code/desciption")
    status: StrictStr = Field(description="The status of the optimization")
