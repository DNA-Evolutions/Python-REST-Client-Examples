...
class BitTypeQualification(QualificationType):
    ...
    """ # noqa: E501
    type_names: List[StrictStr] = Field(description="A list of user-provided type-names. A Contraint type name must match to a Qualification type number (integer) to result in a violation free solution.", alias="typeNames")
