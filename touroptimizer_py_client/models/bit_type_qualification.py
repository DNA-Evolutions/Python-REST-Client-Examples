...
class BitTypeQualification(QualificationType):
    """
    ...
    """ # noqa: E501
    type_names: List[StrictStr] = Field(description="A list of user-provided type-names. A Constraint type name must match to a Qualification type number (integer) to result in a violation free solution.", alias="typeNames")
    type_name: StrictStr = Field(description="The typeName of the object", alias="typeName")
    __properties: ClassVar[List[str]] = ["typeName", "typeNames"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "typeName": obj.get("typeName") if obj.get("typeName") is not None else 'BitType',
