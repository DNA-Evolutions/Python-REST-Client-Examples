...
def main():
    ...
    search_item = DatabaseItemSearch();
    search_item.creator = "TEST_PY_FAF_CREATOR" # magic "hash:" does NOT work here!
    search_item.id = "655ddcc7c59d291272f566d1" # Needs to be a valid id. Either save externally, or search it first
    search_item.time_out = "PT1M";
    

    loaded_opti = tour_optimizer_caller.find_optimization_in_database(search_item)
